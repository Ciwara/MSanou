...
from ui.trash_manager import TrashViewWidget
...
class MenuBar(FMenuBar, FWidget):
    ...
    def __init__(self, parent=None, admin=False, *args, **kwargs):
        ...
        menu = [
            ...
            #  False, "shortcut": "Ctrl+V", "goto": CollectViewWidget},
            {"name": u"corbeille", "icon": 'trash', "admin":
             False, "shortcut": "Ctrl+c", "goto": TrashViewWidget},
